...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "kafka" do |kafka|
    ...
    kafka.vm.synced_folder ".", "/vagrant"
  end
  config.vm.define "spark" do |spark|
    ...
    spark.vm.synced_folder ".", "/vagrant"
  end
  config.vm.define "heron" do |heron|
    ...
    heron.vm.synced_folder ".", "/vagrant"
  end
  ...
  config.vm.define "samza" do |samza|
    ...
    samza.vm.synced_folder ".", "/vagrant"
  end
  config.vm.define "flink" do |flink|
    ...
    flink.vm.synced_folder ".", "/vagrant"
  end
end
